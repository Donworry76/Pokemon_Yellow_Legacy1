...
CeladonMart2FClerk1Text::
	script_mart TM_BODY_SLAM, TM_THUNDER_WAVE, TM_SWIFT, TM_REST, TM_SWORDSDANCE, TM_REST, TM_SWIFT, TM_ROCK_SLIDE, TM_PAY_DAY

CeladonMart2FClerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_RAZOR_WIND, TM_SKULL_BASH, TM_EGG_BOMB, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SOFTBOILED
...
CinnabarMartClerkText::
	script_mart ULTRA_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE, TM_BUBBLEBEAM, TM_DIG, TM_TRI_ATTACK, TM_MIMIC, TM_EARTHQUAKE, HYPER_BEAM, TM_METRONOME, TM_SKULL_BASH
...
IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, HYPER_ POTION, FULL_RESTORE, REVIVE, FULL_HEAL, ELIXER, TM_ICE_BEAM, TM_THUNDERBOLT, TM_FLAMETHROWER, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_SUBMISSION, TM_FLAMETHROWER, TM_DREAM_EATER
