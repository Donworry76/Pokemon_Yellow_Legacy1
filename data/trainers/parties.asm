...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 31, ONIX, 31, KANGASKHAN, 30, MAROWAK, 32, PERSIAN, 0
; Silph Co. 11F
...
; Jessie & James
	...
	db $FF, 42, WEEZING, 41, LICKITUNG, 42, ARBOK, 55, MEOWTH, 43, VICTREEBEL, 0 ; Silph Co. 11F
; Unused
	db 16, KOFFING, 0
	db 27, KOFFING, 0
	db 29, WEEZING, 0
...
ErikaData:
	db $FF, 35, TANGELA, 34, VICTREEBEL, 34, VENUSAUR, 35, VILEPLUME, 0
...
KogaData:
	db $FF, 44, ELECTRODE, 42, MUK, 43, TENTACRUEL, 43, VENOMOTH, 0
...
BlaineData:
	db $FF, 52, RAPIDASH, 53, CHARIZARD, 51, NINETALES, 52, ARCANINE, 53, MAGMAR, 0
; Rematch
	db $FF, 64, RAPIDASH, 64, FLAREON, 64, MOLTRES, 64, NINETALES, 65, ARCANINE, 65, MAGMAR, 0

SabrinaData:
	db $FF, 50, SLOWBRO,  48, HYPNO, 49, MR_MIME, 50, GENGAR,  50, ALAKAZAM, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 20, RATICATE , 22, BEEDRILL, 22, SANDSLASH, 24, EEVEE, 0
; Pokémon Tower 2F
...
; Rematch
	db $FF, 77, MEW, 76, MACHAMP, 75, GYARADOS, 74, TAUROS, 75, VENUSAUR, 77, ARCANINE, 0

LoreleiData:
	db $FF, 56, SLOWBRO, 55, CLOYSTER, 55, ARTICUNO,  56, JYNX, 57, LAPRAS, 0
; Rematch
