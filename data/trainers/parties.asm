...
; Viridian Gym
	db $FF, 56, DUGTRIO, 56, DRAGONAIR, 56, SNORLAX, 56, EXEGGUTOR, 56, RHYDON, 0
...
KogaData:
	db $FF, 44, ELECTRODE, 42, MUK, 43, TENTACRUEL, 43, HYPNO, 0
...
LoreleiData:
	db $FF, 56, STARMIE, 55, CHANSEY, 55, ARTICUNO, 56, JYNX, 57, LAPRAS, 0
; Rematch
...
AgathaData:
	db $FF, 57, GYARADOS, 58, VENUSAUR, 57, MAROWAK, 58, ALAKAZAM, 59, GENGAR, 0
; Rematch
	db $FF, 71, JYNX, 71, GYARADOS, 72, ALAKAZAM, 71, VENUSAUR, 72, ARBOK, 73, GENGAR, 0

LanceData:
	db $FF, 61, DRAGONITE, 60, KANGASKHAN, 60, SEADRA, 61, AERODACTYL, 62, DRAGONITE, 0
; Rematch
