...
; Jessie & James
	db $FF, 20, ARBOK, 22, MEOWTH, 20, WEEZING, 0 ; Mt. Moon B2F
	db $FF, 30, LICKITUNG, 40, MEOWTH, 30, ARBOK, 0 ; Rocket Hideout B4F
	db $FF, 40, MEOWTH, 33, ARBOK, 33, LICKITUNG, 33, WEEZING, 0 ; Pokémon Tower 7F
	db $FF, 45, WEEZING, 45, LICKITUNG, 45, ARBOK, 60, MEOWTH, 45, VICTREEBEL, 0 ; Silph Co. 11F
; Unused
	db 16, KOFFING, 0
	db 27, KOFFING, 0
	db 29, WEEZING, 0
...
ErikaData:
	db $FF, 35, TANGELA, 34, CHANSEY, 36, VENUSAUR, 35, VILEPLUME, 0
